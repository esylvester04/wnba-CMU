...
$$PER * (0.3) + WS * (0.2) + Contract Years * (0.1) + Age penalty * (-0.3)$$

The formula combined the weighted metrics to produce a performance score, and players were ranked within their team. The top five scored players were assumed to be protected.
