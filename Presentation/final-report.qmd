...
* Age penalty to players over 35 to reflect decreased likelihood of protection due to aging. $ \text{PER} * (0.3) + \text{WS} * (0.2) + \text{Contract Years} * (0.1) + \text{Age penalty} * (-0.3)$
